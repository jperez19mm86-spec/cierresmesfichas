...
function aTexto(f, { detalle = false } = {}) {
  ...
  L.push('');
  /* EL SALDO SALIÓ DEL TEXTO (7-sep-2026), igual que de la pantalla y del link. Lo pidió la dueña:
     el sistema de pagos todavía no se usa al 100% y ese número no siempre refleja lo real, así que
     mandárselo al cliente es mandarle algo que puede estar mal. El TOTAL DEL MES de arriba sí es
     exacto. El saldo sigue existiendo adentro del panel, para cobrar. */
